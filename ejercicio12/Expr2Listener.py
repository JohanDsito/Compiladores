...
class Expr2Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Expr2Parser#prog.
    def enterProg(self, ctx:Expr2Parser.ProgContext):
        pass

    # Exit a parse tree produced by Expr2Parser#prog.
    def exitProg(self, ctx:Expr2Parser.ProgContext):
        pass
